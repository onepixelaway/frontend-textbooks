...
4. Source coverage is at least 90% and remains in source order.
...
7. PDF is atomic Letter output, has the expected page count, contains text when required, and passes page rendering.
